...
const Character = ({ id, selectMode, setSelectMode, guessMode, setGuessMode, isCharacter }) => {
    ...
    return <Box sx={() => BoxStyles(clicked, isCharacter)} onClick={handleClick}><img src={`https://raw.githubusercontent.com/hannahmarie9100/tictactoe/31c5ebf2e6c4602c0a344bc885983ef9d3fa58c3/frontend/public/imgs/${id.slice(-3)}.svg`} style={{ height: "100%" }} /></Box>
}
